  ...
  return (
    ...
    <section className="footer">
        <div className="box-container">
          <div className="box">
            <h3>Address</h3>
            <a href="googlemaplink">Faizabad Road , Lucknow</a>
        ...
        <div className="box">
            <h3>Contact Us </h3>
                ...
                <br></br>
                <i className="fa">
                <a href="mailto:info.kimgupta84018@gmail.com">info@kimgupta84018.com</a></i>
            </div>
        <div className="box">
            <h3>Follow us</h3>
            <link
    ...
    <div className="credits">
        <p>© 2024 VASU_GUPTA. All Rights Reserved.</p>
      </div>
    </div>
    </>
  );
